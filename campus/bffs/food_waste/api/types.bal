...
public type GetFoodItemsResponse record {|
...
public type AddFoodItemResponse record {|
    map<json?> __extensions?;
    record {|
        int? id;
        string name;
...
public type UpdateFoodItemResponse record {|
    map<json?> __extensions?;
    record {|
        int? id;
        string name;
...
public type GetMealServingsResponse record {|
    map<json?> __extensions?;
    record {|
        int? id;
        string serving_date;
...
public type AddMealServingResponse record {|
    map<json?> __extensions?;
    record {|
        int? id;
        string serving_date;
...
public type UpdateMealServingResponse record {|
    map<json?> __extensions?;
    record {|
        int? id;
        string serving_date;
...
public type AddFoodWasteResponse record {|
    map<json?> __extensions?;
    record {|
        int? id;
        int meal_serving_id;
...
public type GetWasteDataResponse record {|
    map<json?> __extensions?;
    record {|
        string date;
        anydata? total_waste;
...
public type GetAnalyticsResponse record {|
    map<json?> __extensions?;
    record {|
        anydata average_daily_waste_cost;
        anydata weekly_total_cost;
    |} getAnalyticsData;
|};

public type DeleteFoodItemResponse record {|
    map<json?> __extensions?;
    boolean? delete_food_item;
|};

public type DeleteMealServingResponse record {|
    map<json?> __extensions?;
    boolean? delete_meal_serving;
|};

public type DeleteFoodWasteResponse record {|
    map<json?> __extensions?;
    boolean? delete_food_waste;
|};

public type FoodItemInput record {|
    string name;
    anydata cost_per_portion;
    string meal_type;
|};

public type FoodItemUpdateInput record {|
    string name;
    anydata cost_per_portion;
    string meal_type;
|};

public type MealServingInput record {|
    int organization_id;
    int served_count;
    string serving_date;
    string meal_type;
...
public type MealServingUpdateInput record {|
    int served_count;
    string serving_date;
    string meal_type;
    string? notes;
...
public type FoodWasteInput record {|
    int meal_serving_id;
    int food_item_id;
    int wasted_portions;
|};
