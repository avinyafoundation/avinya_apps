...
class _SMSScaffoldState extends State<SMSScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (campusAppsPortalInstance.isFinance) {
      destinations = [
        MouseRegion(
          onEnter: (_) {
            setState(() {
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: Container(
                child: ListTile(
                  leading:
                      Icon(Icons.add_location, color: Colors.white, size: 20.0),
                  title: Container(
                    margin: EdgeInsets.only(left: 12.0),
                    transform: Matrix4.translationValues(-25, 0.0, 0.0),
                    child: Text(
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: Container(
                child: ListTile(
                  leading:
                      Icon(Icons.add_task, color: Colors.white, size: 20.0),
                  title: Container(
                    margin: EdgeInsets.only(left: 12.0),
                    transform: Matrix4.translationValues(-25, 0.0, 0.0),
                    child: Text(
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: Container(
                child: ListTile(
                  leading:
                      Icon(Icons.info_rounded, color: Colors.white, size: 20.0),
                  title: Container(
                    margin: EdgeInsets.only(left: 12.0),
                    transform: Matrix4.translationValues(-25, 0.0, 0.0),
                    child: Text(
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: Container(
                child: ListTile(
                  leading:
                      Icon(Icons.approval, color: Colors.white, size: 20.0),
                  title: Container(
                    margin: EdgeInsets.only(left: 12.0),
                    transform: Matrix4.translationValues(-25, 0.0, 0.0),
                    child: Text(
    ...
    } else if (campusAppsPortalInstance.isOperations) {
      destinations = [
        MouseRegion(
          onEnter: (_) {
            setState(() {
    ...
    //  else if (campusAppsPortalInstance.isJanitor) {
    //   destinations = [
    //     MouseRegion(
    //       onEnter: (_) {
    //         setState(() {
    ...
    //             child: ListTile(
    //               leading:
    //                   Icon(Icons.view_kanban, color: Colors.white, size: 20.0),
    //               title: Container(
    //                 margin: EdgeInsets.only(left: 12.0),
    //                 transform: Matrix4.translationValues(-25, 0.0, 0.0),
    //                 child: Text(
