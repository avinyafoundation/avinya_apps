...
Future<List<EvaluationCriteriaAnswerOption>>
  ...
  final response = await http.get(
    Uri.parse(
        '${AppConfig.campusAssetsBffApiUrl}/evaluation_criteria_answer_option/evaluation_criteria_answer_options'),
...
Future<EvaluationCriteriaAnswerOption> fetchEvaluationCriteriaAnswerOption(
  ...
  final response = await http.get(
    Uri.parse(
        '${AppConfig.campusAssetsBffApiUrl}/evaluation_criteria_answer_option/evaluation_criteria_answer_options/$id'),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
      'accept': 'application/json',
      'Authorization': 'Bearer ${AppConfig.campusBffApiKey}',
