...
class _MyAlumniScreenState extends State<MyAlumniScreen> {
  ...
  void getUserPerson() async {
    ...
    // int? personId= campusAppsPortalInstance.getUserPerson().id;
    // AlumniPerson AlumniUser = await fetchAlumniPerson(personId!);
    // Person user = await fetchPersonById(personId!);
    setState(() {
