...
import 'package:feedbacks/data/campus_feedback_system.dart';
  ...
  Future<bool> getSignedIn() async {
    ...
    if (tokens != null) {
      ...
      if (_openid_tokens != null && _openid_tokens['access_token'] != null) {
        ...
        campusFeedbackSystemInstance.setJWTSub(decodedAccessToken["sub"]);
        campusFeedbackSystemInstance.setJWTEmail(decodedAccessToken["email"]);
        campusFeedbackSystemInstance.setDigitalId(decodedAccessToken["email"]);
