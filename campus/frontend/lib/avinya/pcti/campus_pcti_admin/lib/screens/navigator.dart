...
import 'package:campus_pcti_admin/screens/pcti_note_details.dart';
import 'package:campus_pcti_admin/screens/pcti_notes.dart';
...
class _SMSNavigatorState extends State<SMSNavigator> {
  ...
  final _pctiActivityDetailsKey = const ValueKey('PCTI Activity details screen');
