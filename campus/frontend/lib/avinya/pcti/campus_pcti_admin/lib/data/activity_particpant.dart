...
Future<http.Response> createActivityParticipant(ActivityParticipant activityParticipant) async {
    final http.Response response = await http.post(
        Uri.parse(AppConfig.campusPctiBffApiUrl + '/activity_participant'),
