...
import 'package:campus_pcti_admin/data/campus_config_system.dart';
...
class _CampusPctiSystemState
  ...
  Future<ParsedRoute> _guard(ParsedRoute from) async {
    ...
    // Go to /application if the user is signed in and tries to go to /signin.
      ...
      return ParsedRoute('/admin/pcti/substitute', '/admin/pcti/substitute', {}, {});
      // return pctiActivitiesSubstituteRoute;
    }
    else if (signedIn && from == signInRoute) {
      return ParsedRoute('/admin/pcti_activities', '/admin/pcti_activities', {}, {});
    }
