...
class VehicleFuelConsumptionTable extends StatefulWidget {
  const VehicleFuelConsumptionTable({Key? key, required this.title})
      : super(key: key);

  final String title;

  @override
  State<VehicleFuelConsumptionTable> createState() =>
      _VehicleFuelConsumptionTableState();
}

class _VehicleFuelConsumptionTableState
    extends State<VehicleFuelConsumptionTable> {
                                            ...
                                            return DataRow(
                                              cells: [
                                                ...
                                                DataCell(
                                                  TextButton(
                                                    onPressed: () {
                                                      // Handle redirection to the new screen
                                                      routeState.go(
                                                          '/edit_screen/${item.id}');
                                                    },
                                                    child: Text('Edit'),
