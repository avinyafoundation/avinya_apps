...
class _CompletedEventCardState extends State<CompletedEventCard> {
  ...
  void initState() {
    ...
    if(activityEvaluation !=null){
      setState(() {
        ...
        selectedRating = activityEvaluation.rating != -1 ? activityEvaluation.rating:null;
  ...
  void submitFeedback() async{
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Feedback submitted! Thank you for your support.')),
    );
  }
              ...
              Row(
                children: List.generate(5, (index) {
                  return IconButton(
                    ...
                    onPressed:isFeedbackSubmitted ? null : () {
