...
class _AlumniSystemState extends State<AlumniSystem> {
  ...
  void initState() {
    ...
    _routeParser = TemplateRouteParser(
      allowedPaths: [AppRoutes.alumniHome,'/signin',
        '/#access_token',
      ],
      guard: _guard,
      // initialRoute: '/signin',
      initialRoute: AppRoutes.alumniHome,
    );
  ...
  Future<ParsedRoute> _guard(ParsedRoute from) async {
    ...
    final alumniHomeRoute =
        ParsedRoute(AppRoutes.alumniHome, AppRoutes.alumniHome, {}, {});

    if (signedIn && from == alumniHomeRoute) {
      return alumniHomeRoute;
  ...
  void _handleAuthStateChanged() async {
    ...
    if (!signedIn) {
      _routeState.go(AppRoutes.alumniHome);
    }
  }
