...
class _DutyAttendanceMarkerState extends State<DutyAttendanceMarker> {
  ...
  Future<void> submitDutyAttendance(
      DutyParticipant dutyParticipant, TimeOfDay selectedTime) async {
    ...
    dutyAttendance = _fetchedDutyAttendance.firstWhere(
        ...
        orElse: () => new ActivityAttendance(sign_in_time: null));
      ...
      child: Column(
        children: [
          ...
          SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _dutyParticipants.isEmpty ? const SizedBox() : buildTable(),
                ],
              )),
        ],
      ),
